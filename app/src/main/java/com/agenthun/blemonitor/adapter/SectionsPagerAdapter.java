package com.agenthun.blemonitor.adapter;
...
import com.agenthun.blemonitor.fragment.TrackFragment;
...
public class SectionsPagerAdapter extends FragmentPagerAdapter {
    ...
    public Fragment getItem(int position) {
        ...
        switch (position) {
            ...
            case 1:
                return TrackFragment.newInstance("2", "1070");
/*            case 2:
    ...
    public CharSequence getPageTitle(int position) {
        switch (position) {
            ...
            case 1:
                return App.getContext().getString(R.string.page_title_track);
/*            case 2:
